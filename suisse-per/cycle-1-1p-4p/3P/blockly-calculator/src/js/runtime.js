...
function updateCalculatorFunction() {
    ...
    status.textContent = '✅ Fonction connectée - La calculatrice utilise ton algorithme !';
    } else {
    ...
    var status = document.getElementById('status');
    status.className = 'status disconnected';
    status.textContent = '⚠️ Crée une fonction "calculer" avec des blocs d\'opération';
    }
    } catch (error) {
